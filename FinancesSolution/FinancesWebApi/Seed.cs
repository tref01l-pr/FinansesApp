...
namespace FinancesWebApi.Data
{
    public class Seed
    {
        ...
        public void SeedData()
        {
            ...
            {
                new ExpenseCategory { Name = "Health", IsDefault = true, ExpenseIcon = expenseIcons[0], IconColor = iconColors[0]},
                new ExpenseCategory { Name = "Home", IsDefault = true, ExpenseIcon = expenseIcons[1], IconColor = iconColors[1]}
            };
            ...
            {
                new IncomeCategory { Name = "Health", IsDefault = true, IncomeIcon = incomeIcons[0], IconColor = iconColors[0]},
                new IncomeCategory { Name = "Home", IsDefault = true, IncomeIcon = incomeIcons[1], IconColor = iconColors[1]}
            };
